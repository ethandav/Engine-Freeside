...
namespace efg::d3d12
{
    ...
    void D3D12ShaderLibrary::CompileAllShaders()
    {
        AddShader(
            ShaderId::GeometryVS,
            L"..\\Engine\\efg\\assets\\shaders\\GeometryTransform_VS.hlsl",
            L"VSMain",
            L"vs_6_6"
        );
        ...
        AddShader(
            ...
            L"..\\Engine\\efg\\assets\\shaders\\ForwardLighting_PS.hlsl",
            L"PSMain",
            L"ps_6_6"
        );
        ...
        AddShader(
            ShaderId::SkyboxPS,
            L"..\\Engine\\efg\\assets\\shaders\\Skybox_PS.hlsl",
            L"PSMain",
            L"ps_6_6"
        );
        ...
        AddShader(
            ShaderId::SkyboxVS,
            L"..\\Engine\\efg\\assets\\shaders\\Skybox_VS.hlsl",
            L"VSMain",
            L"vs_6_6"
        );
    }
