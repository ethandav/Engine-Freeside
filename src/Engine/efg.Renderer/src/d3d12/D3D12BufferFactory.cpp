...
GpuBuffer BufferFactory::CreateStaticBuffer(ID3D12Device* device, ID3D12GraphicsCommandList* commandList, const void* data, UINT64 sizeInBytes, D3D12_RESOURCE_STATES finalState)
{
    GpuBuffer buffer = {};
