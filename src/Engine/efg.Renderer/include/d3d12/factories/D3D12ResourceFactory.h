...
namespace efg::d3d12
{
    ...
    public:
        ...
        void CreateCommittedTexture2DResource(GpuTexture2D* texture, D3D12_RESOURCE_FLAGS flags, D3D12_RESOURCE_STATES initialState, const D3D12_CLEAR_VALUE* clearValue = nullptr);
        void CreateCommittedTextureCubeResource(GpuTextureCube* texture, D3D12_RESOURCE_FLAGS flags, D3D12_RESOURCE_STATES initialState, const D3D12_CLEAR_VALUE* clearValue = nullptr);
        void CreateCommittedDepthTexture2DResource(GpuTexture2D* texture);
        void CreateCommittedDepthTextureCubeResource(GpuTextureCube* texture);
